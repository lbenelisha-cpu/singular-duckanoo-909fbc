...
const capacityFallbackRows = buildResourceRows({
  targets:[{ month:'2026-09', resource:'Galigan (25,40)', facility:'1540', facilities:['1540'], target:0, capacity:45000 }],
  planningMonth:'2026-09',
  now:new Date('2026-09-04'),
})
assert.equal(capacityFallbackRows[0].target, 45000)
