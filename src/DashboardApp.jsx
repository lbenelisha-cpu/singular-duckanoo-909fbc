...
material: normalize(getField(r, [
  ...
  if (IS_MOBILE_DEVICE) return <div className="mobile-lite-app" dir="rtl">
    <header className="mobile-lite-header">
      <div><img src="/icons/iml-brand-v11-64.png" alt="IML"/><span><strong>IML CONTROL</strong><small>כמות · איכות</small></span></div>
  ...
  if (showHome) return <div className="command-home" dir="rtl">
    <header className="command-home-header">
      <div className="command-home-brand"><img src="/icons/iml-brand-v11-128.png" alt="IML"/><div><strong>חדר בקרה — מתקני אריזה</strong><span>COMMAND CENTER</span></div></div>
  ...
  return <div className={`dashboard ${sidebarCollapsed ? 'sidebar-collapsed' : ''} ${managementMode ? 'management-mode' : ''}`} dir="rtl">
    <aside className="side filter-side">
      ...
      <div className="brand branded"><img src="/icons/iml-brand-v11-128.png" alt="IML"/><div>IML<span>CONTROL</span></div></div>
