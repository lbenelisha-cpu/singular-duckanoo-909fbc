...
function SetupRequired(){ return <div className="auth-page" dir="rtl"><div className="auth-card setup-card"><div className="auth-icon"><Cloud/></div><h1>נדרש חיבור לענן</h1><p>Build 9.1 מוכן למערכת משתמשים, אך חסרים משתני החיבור של Supabase.</p><code>VITE_SUPABASE_URL</code><code>VITE_SUPABASE_ANON_KEY</code><div className="setup-note">הוסף אותם ב־Netlify תחת Environment variables ובצע Deploy מחדש.</div></div></div> }
